...
const EditDetails = () => {
  ...
  const diagnosis = [
    ...
    { label: 'Double Outlet Right Ventricle (2 ventricle repair/Not Fontan)', value: '6' },
    ...
    { label: 'Total or Partial Anomalous Pulmonary Venous Connection', value: '13' },
  ...
  return (
    ...
    <View style={styles.inputContainer}>
        ...
        <Dropdown
          ...
          data={[{label: "Male", value: "1"},{label: "Female", value: "2"},{label: "Rather not answer", value: "3"}]}
          labelField="label"
          valueField="value"
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Are you followed by a congenital cardiologist at Penn State:</Text>
        <Dropdown
          style={[styles.dropdown, isFocus && { borderColor: 'blue' }]}
          data={[{label: "Yes", value: "1"}, {label: "No", value: "2"}, {label: "I'd rather not answer", value: "3"}]}
          labelField="label"
          valueField="value"
          placeholder={'Select an option'}
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Who is your primary congenital cardiologist:</Text>
        <Dropdown
          style={[styles.dropdown, isFocus && { borderColor: 'blue' }]}
          data={diagnosis}
          labelField="label"
